...
//      }   
  ...
  stage('Deploy application to cloudHub'){
   steps{
     script{
       configFileProvider([configFile(fileId: 'b0e08ae7-e5db-4166-956b-41ced22fd16e', variable: 'settings')]){
       sh 'mvn -f pom.xml -s $settings deploy -DmuleDeploy -DskipTests -DconnApp.id=ccb6a047babe4d7aab87d8f12251b78a -DconnApp.secret=08839154734143C4Bf594830ec8e05A8 -DapplicationName=hello-world-jilty-dev-in -Danypoint.businessGroup="NJC India"'
       }
     }
   }
  } 
